...
const PORTAL_NAV = [
  ...
  {
    to: '/portal/cotizaciones', label: 'Cotizaciones',
        ...
        <nav className={`nds-portal-nav${mobileOpen ? ' mobile-open' : ''}`}>
          ...
          {userData?.role === 'admin' && (
            <>
              ...
              <NavLink
                to="/portal/admin/precios"
                onClick={closeMobile}
                className={({ isActive }) => `nds-portal-nav-link${isActive ? ' active' : ''}`}
              >
                <NavIcon d={<><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></>} />
                Precios
              </NavLink>
              <NavLink
