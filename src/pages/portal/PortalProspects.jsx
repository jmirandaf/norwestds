...
const MOCK_PLANTS = [
  ...
  { id: '9',  name: 'Sanyo North America',           sector: 'Electrónico',   lat: 32.5257, lng: -116.9202, address: 'Mesa de Otay, Tijuana, BC',                          employees: 950,  potential: 3, status: 'prospecto', notes: null },
  { id: '10', name: 'GE Healthcare',                 sector: 'Médico',        lat: 32.5307, lng: -116.9179, address: 'Mesa de Otay, Tijuana, BC',                          employees: 1400, potential: 5, status: 'prospecto', notes: null },
  { id: '11', name: 'WMS Industries',                sector: 'Electrónico',   lat: 32.5276, lng: -116.9193, address: 'Mesa de Otay, Tijuana, BC',                          employees: 450,  potential: 2, status: 'prospecto', notes: null },
  { id: '12', name: 'Prolec GE (GE Vernova)',        sector: 'Eléctrico',     lat: 32.5265, lng: -116.9223, address: 'Mesa de Otay, Tijuana, BC',                          employees: 700,  potential: 5, status: 'prospecto', notes: null },
  { id: '13', name: 'Hyundai Mobis',                 sector: 'Automotriz',    lat: 32.4802, lng: -116.8827, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 2200, potential: 5, status: 'prospecto', notes: null },
  { id: '14', name: 'Foxconn México',                sector: 'Electrónico',   lat: 32.4825, lng: -116.8775, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 4000, potential: 4, status: 'prospecto', notes: null },
  { id: '15', name: 'Johnson Controls',              sector: 'Automotriz',    lat: 32.4798, lng: -116.8862, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 1700, potential: 5, status: 'prospecto', notes: null },
  { id: '16', name: 'Medtronic Neurológico',         sector: 'Médico',        lat: 32.4811, lng: -116.8841, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 800,  potential: 5, status: 'prospecto', notes: null },
  { id: '17', name: 'Kyocera International',         sector: 'Electrónico',   lat: 32.4832, lng: -116.8812, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 1300, potential: 3, status: 'prospecto', notes: null },
  { id: '18', name: 'Jabil Circuit',                 sector: 'Electrónico',   lat: 32.4808, lng: -116.8851, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 2800, potential: 4, status: 'prospecto', notes: null },
  { id: '19', name: 'Boston Scientific',             sector: 'Médico',        lat: 32.4793, lng: -116.8869, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 900,  potential: 5, status: 'prospecto', notes: null },
  { id: '20', name: 'Haas Automation México',        sector: 'Metalmecánico', lat: 32.4840, lng: -116.8845, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 350,  potential: 5, status: 'prospecto', notes: null },
  { id: '21', name: 'Flextronics (Flex Ltd)',        sector: 'Electrónico',   lat: 32.4789, lng: -116.8876, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 3200, potential: 4, status: 'prospecto', notes: null },
  { id: '22', name: 'Chamberlain Group',             sector: 'Electrónico',   lat: 32.4821, lng: -116.8830, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 600,  potential: 4, status: 'prospecto', notes: null },
  { id: '23', name: 'Canon México',                  sector: 'Electrónico',   lat: 32.4815, lng: -116.8823, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 1100, potential: 3, status: 'prospecto', notes: null },
  { id: '24', name: 'Regal Rexnord',                 sector: 'Metalmecánico', lat: 32.4826, lng: -116.8835, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 550,  potential: 5, status: 'prospecto', notes: null },
  { id: '25', name: 'Orbis Corp',                    sector: 'Plástico',      lat: 32.4795, lng: -116.8891, address: 'Parque Industrial El Florido, Tijuana, BC',          employees: 400,  potential: 2, status: 'prospecto', notes: null },
  { id: '26', name: 'Honeywell Aerospace',           sector: 'Aeroespacial',  lat: 32.4178, lng: -116.9315, address: 'Parque Industrial Pacifico, Tijuana, BC',            employees: 1200, potential: 5, status: 'prospecto', notes: null },
  { id: '27', name: 'Zodiac Aerospace (Safran)',     sector: 'Aeroespacial',  lat: 32.4163, lng: -116.9341, address: 'Parque Industrial Pacifico, Tijuana, BC',            employees: 850,  potential: 5, status: 'prospecto', notes: null },
  { id: '28', name: 'Celestica',                     sector: 'Electrónico',   lat: 32.4155, lng: -116.9322, address: 'Parque Industrial Pacifico, Tijuana, BC',            employees: 2000, potential: 4, status: 'prospecto', notes: null },
  { id: '29', name: 'Molex de México',               sector: 'Electrónico',   lat: 32.4191, lng: -116.9298, address: 'Parque Industrial Pacifico, Tijuana, BC',            employees: 1800, potential: 4, status: 'prospecto', notes: null },
  { id: '30', name: 'Parker Hannifin',               sector: 'Metalmecánico', lat: 32.4172, lng: -116.9309, address: 'Parque Industrial Pacifico, Tijuana, BC',            employees: 700,  potential: 5, status: 'prospecto', notes: null },
  { id: '31', name: 'Kenworth Mexicana',             sector: 'Automotriz',    lat: 32.5183, lng: -116.9505, address: 'Parque Industrial Cuauhtémoc, Tijuana, BC',          employees: 3100, potential: 5, status: 'prospecto', notes: null },
  { id: '32', name: 'Eaton Corporation',             sector: 'Eléctrico',     lat: 32.4988, lng: -116.9498, address: 'Parque Industrial Cuauhtémoc, Tijuana, BC',          employees: 950,  potential: 5, status: 'prospecto', notes: null },
  { id: '33', name: 'Hubbell Power Systems',         sector: 'Eléctrico',     lat: 32.4973, lng: -116.9512, address: 'Parque Industrial Cuauhtémoc, Tijuana, BC',          employees: 600,  potential: 4, status: 'prospecto', notes: null },
  { id: '34', name: 'National Instruments (NI)',     sector: 'Electrónico',   lat: 32.4962, lng: -116.9487, address: 'Parque Industrial Cuauhtémoc, Tijuana, BC',          employees: 750,  potential: 5, status: 'prospecto', notes: null },
  { id: '35', name: 'Vitro Automotriz',              sector: 'Automotriz',    lat: 32.4955, lng: -116.9523, address: 'Parque Industrial Cuauhtémoc, Tijuana, BC',          employees: 1100, potential: 4, status: 'prospecto', notes: null },
  { id: '36', name: 'Infineon Technologies (IR)',    sector: 'Electrónico',   lat: 32.5123, lng: -116.9612, address: 'Zona Industrial La Mesa, Tijuana, BC',               employees: 950,  potential: 4, status: 'prospecto', notes: null },
  { id: '37', name: 'Merit Medical Systems',         sector: 'Médico',        lat: 32.5138, lng: -116.9594, address: 'Zona Industrial La Mesa, Tijuana, BC',               employees: 700,  potential: 5, status: 'prospecto', notes: null },
  { id: '38', name: 'ISOSA Electrónica',             sector: 'Electrónico',   lat: 32.5112, lng: -116.9625, address: 'Zona Industrial La Mesa, Tijuana, BC',               employees: 320,  potential: 3, status: 'prospecto', notes: null },
]
      ...
      {Array.from({ length: 5 }, (_, i) => (
        <span
          ...
          style={{
            ...
            background: i < value ? POTENTIAL_COLORS[value] : '#e2e8f0',
          }}
        />
      ))}
    </span>
    ...
    <PortalLayout title="Mapa de Prospectos" subtitle="Plantas de manufactura en Baja California">
      <div style={{ display: 'flex', gap: 0, height: 'calc(100vh - 120px)', minHeight: 540, borderRadius: 12, overflow: 'hidden', border: '1px solid var(--nds-border, #e2e8f0)' }}>
        ...
        <div style={{ flex: 1, position: 'relative' }}>
          ...
          {error && (
            <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f8fafc', zIndex: 999, padding: 32, textAlign: 'center' }}>
              <svg width="40" height="40" fill="none" stroke="#ef4444" strokeWidth="1.5" viewBox="0 0 24 24" style={{ marginBottom: 12 }}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
              <p style={{ color: '#ef4444', fontWeight: 600, marginBottom: 6 }}>Sin conexión al backend</p>
              <p style={{ color: '#64748b', fontSize: 13 }}>{error}</p>
              <p style={{ color: '#94a3b8', fontSize: 12, marginTop: 8 }}>Ejecuta: <code>cd backend && npm run dev</code></p>
            </div>
          )}
          {!loading && !error && (
            <MapContainer
                  ...
                  <Popup>
                    <div style={{ minWidth: 200 }}>
                      ...
                      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 8 }}>
                        ...
                        <span style={{ fontSize: 11, padding: '2px 8px', borderRadius: 999, background: STATUS_COLORS[plant.status] || '#94a3b8', color: '#fff', fontWeight: 600 }}>
                          {STATUS_LABELS[plant.status] || plant.status}
                        </span>
                      </div>
                      {plant.employees && <div style={{ fontSize: 12, color: '#64748b', marginBottom: 4 }}>{plant.employees.toLocaleString()} empleados</div>}
                      <div style={{ fontSize: 12, color: '#64748b', marginBottom: 6 }}>Potencial: <PotentialDots value={plant.potential} /> <span style={{ color: POTENTIAL_COLORS[plant.potential] }}>{POTENTIAL_LABELS[plant.potential]}</span></div>
