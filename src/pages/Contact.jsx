    ...
    <PageLayout>
      ...
      <div className="ns-page-header">
        <div className="ns-page-header-inner">
          <div className="ns-eyebrow"><span className="ns-eyebrow-dot" />{t('contact.eyebrow')}</div>
      ...
      <section className="ns-section">
        <div className="ns-section-inner">
          <div className="ns-grid ns-grid--2" style={{ alignItems: 'start', gap: 48 }}>
            {/* Formulario */}
            <div>
              <h2 className="nds-h2" style={{ marginBottom: 24 }}>{t('contact.sendMessage')}</h2>
              <ContactForm />
            </div>

            {/* Info */}
            <div>
              <h2 className="nds-h2" style={{ marginBottom: 24 }}>{t('contact.contactInfo')}</h2>
